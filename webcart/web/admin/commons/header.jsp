...
<head>
    ...
    <link rel="stylesheet" href="css/datapicker/bootstrap-datetimepicker.min.css>
                    ...
                    <li class="active">
                        ...
                        <ul class="submenu-angle" aria-expanded="true">
                            <li><a title="Dashboard v.1"
                                   href="${pageContext.servletContext.contextPath}/admin/index.jsp"><span
                                    class="mini-sub-pro">用户列表</span></a></li>
                            <li><a title="Dashboard v.2"
                                   href="${pageContext.servletContext.contextPath}/admin/order.jsp"><span
                                    class="mini-sub-pro">订单管理</span></a></li>
                        </ul>
                    </li>
                    <li>
                        <a title="Landing Page" href="${pageContext.servletContext.contextPath}/admin/admin-user.jsp"
                           aria-expanded="false"><span class="fa fa-user-circle-o" aria-hidden="true"></span> <span
                    ...
                    <li>
                        ...
                        <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="All Professors" href="all-professors.html"><span
                                    class="mini-sub-pro">菜单管理</span></a></li>
                            <li><a title="Add Professor" href="add-professor.html"><span
                                    class="mini-sub-pro">角色管理</span></a></li>
                            <li><a title="Edit Professor" href="edit-professor.html"><span
                                    class="mini-sub-pro">字典管理</span></a></li>
                            <li><a title="Professor Profile" href="professor-profile.html"><span class="mini-sub-pro">权限管理</span></a>
                            </li>
                        </ul>
                    </li>
                </ul>
                                    ...
                                    <div class="header-right-info">
                                        <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                            <li class="nav-item dropdown">
                                                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false"
                                                   class="nav-link dropdown-toggle"><i class="fa fa-envelope"
                                            ...
                                            <li class="nav-item nav-setting-open"><a href="#" data-toggle="dropdown"
                                                                                     ...
                                                                                     class="nav-link dropdown-toggle"><i
                                                    class="fa fa-drivers-license"></i></a>
